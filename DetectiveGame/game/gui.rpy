...
define gui.accent_color = '#D4AF37'  # gold accent
...
define gui.dialogue_text_size = 22  # smaller dialogue/narration font size
...
define gui.textbox_bottom_safe_margin = 32   # safe area to avoid desktop taskbar
...
style window:
    ...
    background Solid("#000000CC")  # semi-transparent black overlay
...
style namebox:
    ...
    # Use frame for a bordered box (gold accent handled via name text + frame asset)
    background Frame("gui/frame.png", gui.namebox_borders, tile=gui.namebox_tile)
...
style say_dialogue:
    ...
    outlines [(2, "#000000CC", 0, 0), (1, "#00000088", 0, 2)]
